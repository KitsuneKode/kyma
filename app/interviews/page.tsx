...
export default function CandidateDashboard() {
  return (
    <div className="flex min-h-screen flex-col bg-muted/10">
      <header className="sticky top-0 z-50 flex h-16 items-center justify-between border-b border-border/40 bg-background/80 px-6 backdrop-blur-xl md:px-12">
      ...
      <main className="flex-1 px-6 py-12 md:px-12 lg:py-20">
                ...
                <div className="space-y-6">
                  <div className="rounded-2xl bg-muted/20 p-6 ring-1 ring-border/50">
                    ...
                    <p className="mt-3 text-sm leading-relaxed text-pretty text-muted-foreground">
                      Aarav demonstrated exceptional clarity when explaining
                      complex calculus concepts. The candidate showed immense
                      patience during the simulated student misunderstanding and
                      quickly adapted their teaching method. The overall tone
                      was warm and highly encouraging.
                    </p>
                  </div>
                  ...
                  <div className="grid gap-4 sm:grid-cols-2">
                    ...
                    <div className="flex items-start gap-4 rounded-2xl bg-muted/10 p-5 ring-1 ring-border/30">
                      ...
                      <div>
                        ...
                        <p className="mt-1 text-xs text-muted-foreground">
                          Strong. Navigated frustration with empathy and
            ...
            <div className="space-y-6">
              ...
              <section className="rounded-3xl bg-card p-6 shadow-[0_8px_40px_-12px_rgba(0,0,0,0.05)] ring-1 ring-border/50">
                ...
                <div className="rounded-2xl border border-dashed border-border/60 bg-muted/10 p-5 text-center transition-colors hover:bg-muted/20">
                  ...
                  <Button
                    className="mt-4 w-full rounded-xl shadow-sm transition-transform active:scale-[0.96]"
                    nativeButton={false}
                  >
