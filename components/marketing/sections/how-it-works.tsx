...
function StepBadge({ number }: { number: number }) {
  return (
    <span className="inline-flex items-center gap-2 rounded-full bg-white/10 px-3 py-1 text-[10px] font-semibold tracking-widest text-white/70 uppercase">
...
function BatchCreationMock() {
  return (
    <div className="mt-8 space-y-4">
      <div className="flex items-center gap-3 rounded-xl bg-white/5 p-4 ring-1 ring-white/5">
        <div className="flex size-10 items-center justify-center rounded-lg bg-white/5">
          <IconLink className="size-5 text-white/60" />
        </div>
      ...
      <div className="flex gap-3">
        <div className="flex flex-1 items-center gap-2 rounded-lg bg-white/5 p-3">
          <IconCalendar className="size-4 text-white/40" />
          <div className="h-1.5 w-20 rounded-full bg-white/15" />
        </div>
        <div className="flex flex-1 items-center gap-2 rounded-lg bg-white/5 p-3">
          <IconShield className="size-4 text-white/40" />
...
function InterviewMock() {
  return (
    <div className="mt-8">
      <div className="relative overflow-hidden rounded-xl bg-white/5 p-6 ring-1 ring-white/5">
        <div className="absolute inset-0 bg-gradient-to-br from-primary/5 via-transparent to-transparent" />
        <div className="relative flex items-center justify-center gap-6">
          <motion.div
            animate={{ scale: [1, 1.2, 1] }}
            transition={{ duration: 2, repeat: Infinity, ease: 'easeInOut' }}
            className="flex size-16 items-center justify-center rounded-full bg-white/5 ring-1 ring-white/10"
          >
            <IconVolume className="size-8 text-white/60" />
          </motion.div>
    ...
    <div className="mt-8 space-y-3">
      ...
      <div className="flex items-center justify-between rounded-lg bg-primary/10 p-3 ring-1 ring-primary/20">
        <div className="flex items-center gap-2">
          ...
          <span className="text-xs font-medium text-white">Strong Yes</span>
        </div>
      ...
      <div className="mx-auto max-w-7xl px-6">
        ...
        >
          ...
          <motion.div
            ...
            className="group relative overflow-hidden rounded-[2.5rem] bg-[#0a0a0a] p-8 shadow-2xl ring-1 ring-white/10 lg:col-span-2 lg:p-12"
          >
            {/* Gradient orb */}
            ...
            <div className="relative grid gap-8 lg:grid-cols-2 lg:gap-12">
              <div>
                ...
                <p className="mt-4 text-lg text-pretty text-white/60">
          ...
          <motion.div
            variants={itemVariants}
            className="group relative overflow-hidden rounded-[2rem] bg-[#0a0a0a] p-8 shadow-2xl ring-1 ring-white/10"
          >
            ...
            <div className="relative">
              <div className="mb-6 flex items-center gap-4">
                <StepIcon icon={IconMicrophone} color="#e8ff47" />
                <StepBadge number={2} />
              </div>
          ...
          >
            ...
            <div className="relative">
              <div className="mb-6 flex items-center gap-4">
                <StepIcon icon={IconReportAnalytics} color="#e8ff47" />
                <StepBadge number={3} />
              </div>
              <h3 className="text-2xl font-semibold tracking-tight text-white">
                Review and decide
