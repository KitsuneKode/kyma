...
export function sliceLivekitEnv(source: LivekitEnvSlice): LivekitEnvSlice {
  return {
    NEXT_PUBLIC_LIVEKIT_URL: source.NEXT_PUBLIC_LIVEKIT_URL,
    LIVEKIT_API_KEY: source.LIVEKIT_API_KEY,
    LIVEKIT_API_SECRET: source.LIVEKIT_API_SECRET,
    LIVEKIT_AGENT_NAME: source.LIVEKIT_AGENT_NAME,
    LIVEKIT_WEBHOOK_API_KEY: source.LIVEKIT_WEBHOOK_API_KEY,
    LIVEKIT_WEBHOOK_API_SECRET: source.LIVEKIT_WEBHOOK_API_SECRET,
    LIVEKIT_RECORDING_ENABLED: source.LIVEKIT_RECORDING_ENABLED,
    LIVEKIT_RECORDING_AUDIO_ONLY: source.LIVEKIT_RECORDING_AUDIO_ONLY,
    LIVEKIT_RECORDING_TEMPLATE_URL: source.LIVEKIT_RECORDING_TEMPLATE_URL,
    LIVEKIT_RECORDING_STORAGE_BUCKET: source.LIVEKIT_RECORDING_STORAGE_BUCKET,
    LIVEKIT_RECORDING_STORAGE_REGION: source.LIVEKIT_RECORDING_STORAGE_REGION,
    LIVEKIT_RECORDING_STORAGE_ACCESS_KEY:
      source.LIVEKIT_RECORDING_STORAGE_ACCESS_KEY,
    LIVEKIT_RECORDING_STORAGE_SECRET_KEY:
      source.LIVEKIT_RECORDING_STORAGE_SECRET_KEY,
  }
}
