...
export const DEFAULT_TEMPLATE_SYSTEM_PROMPT = `
...
export const DEFAULT_TEMPLATE_CHILD_PERSONA_PROMPT = `
...
export const DEFAULT_TEMPLATE_WRAP_UP_PROMPT = `
...
export function buildDefaultRubricConfig(): TemplateRubricConfig {
  return {
...
export const DEFAULT_TEMPLATE_STARTER_CONTENT = {
  systemPrompt: DEFAULT_TEMPLATE_SYSTEM_PROMPT,
  childPersonaPrompt: DEFAULT_TEMPLATE_CHILD_PERSONA_PROMPT,
  wrapUpPrompt: DEFAULT_TEMPLATE_WRAP_UP_PROMPT,
  rubricConfig: buildDefaultRubricConfig(),
} as const
